...
DIR_FREQ_PATH = file.path("..", "..", "..",
                     "Datasets","twitter-sars-cov-2",
                     "freqterms")
saveRDS(object = freq.terms, file = file.path(DIR_FREQ_PATH, "ngram",NGRAMS, "_pure_freq_terms.rds"))
saveRDS(object = freq.terms.all, file = file.path(DIR_FREQ_PATH, "ngram",NGRAMS, "_pure_freq_terms_all.rds"))
