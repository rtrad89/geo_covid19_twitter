...
for (val in unique(five_g_tweets$src))
{
  ...
  # print(paste("5g synonyms were unified in",
  #             val))
  # print(five5_synonyms)
  # Unify coronavirus synonyms
  coronavirus_synonyms = c("corona virus","covid 19",
  ...
  # FIXME: no 5g mentions are being recorded any more
