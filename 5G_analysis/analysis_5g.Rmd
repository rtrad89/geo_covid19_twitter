...
preprocess_texts = function(texts, val)
{
  # Communicate what basic preprocessing did:
  print(paste("URLs, smilies, emojies and mentions had been removed from dataset:", val))
  # Some cleaning:
  ...
  # print(paste("Hashtags removed from dataset:", val))
  
  # Remove punctuation
  texts = tm_map(texts, removePunctuation)
  print(paste("Punctuation removed from dataset:", val))
  ...
  print(paste("Standalone numbers removed from dataset:", val))
  ...
  print(paste("English stopwords removed from dataset:", val))
  ...
  print(paste("Snowball Stemming done for dataset:", val))
