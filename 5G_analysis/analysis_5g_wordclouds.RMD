...
# Removing sparsity!
val = "non_5G"
print("Due to technical problems, we are removing terms whose sparsity exceed 99.8% but in 5G datasets")
dtm_all_tweets = removeSparseTerms(x = dtm_all_tweets, sparse = 0.998)
dtm_n5g_tweets = removeSparseTerms(x = dtm_n5g_tweets, sparse = 0.998)
