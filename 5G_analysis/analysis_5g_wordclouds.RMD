...
# Removing sparsity!
val = "non_5G"
# print("Due to technical problems, we are removing terms whose sparsity exceed 98.5% but in 5G datasets")
# dtm_all_tweets = removeSparseTerms(x = dtm_all_tweets, sparse = 0.985)
#dtm_n5g_tweets = removeSparseTerms(x = dtm_n5g_tweets, sparse = 0.985)

# Make the general wordcloud for non 5g terms
m <- as.matrix(dtm_all_tweets)
# FILTER OUT 5G TERMS!
# TODO cannot due to memory constraints
